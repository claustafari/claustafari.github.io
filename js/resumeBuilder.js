...
var bio = {
    ...
    "welcomeMessage": "Howdy! Welcome to my interactive resume application that I developed using jQuery. The resume reads all data from a JSON file and then dynamically modifies the DOM to display the information. I customized the project by personalizing the design using CSS. It's an ongoing project, which explains why some parts are 'under construction'.",
    "skills": ["HTML ", "CSS ", "Adobe InDesign ", "JavaScript ", "jQuery", "Copy-Writing ", "Research ", "Google AdWords Certified ", "SEO"],
    "biopic": "images/resizeimage.png"
};
...
var projects = {
    "projects": [{
        ...
        },
        {
            ...
            "dates": "2017",
            "description": "Using jQuery, I developed an interactive resume application that reads all data from a JSON file and then dynamically modifies the DOM to display the information. I customized the project by personalizing the design using CSS.",
            "images": ["images/197x148.gif"],
            "url": "https://profiles.udacity.com/p/7231491628"
        },
        {
            ...
            "dates": "2017",
            "description": "Made a color-picker game using vanilla JS. The game improves the players ability to predict a given color based on its RGB values.",
            "images": ["images/197x148.gif"],
            "url": "https://github.com/claustafari/Color-Game"
        },
        {
        ...
        },
        {
            "title": "Mini Library",
            "dates": "2017",
            "description": "Developed a JavaScript library that can be used across projects. My library mimics - and has a jQuery dependency.",
            "images": ["images/197x148.gif"],
            "url": "https://github.com/claustafari/Mini-Library-Greetr"
        },
        {
            "title": "Todo-List App",
            "dates": "In progress",
            "description": "I am making a visually stunning, interactive Todo-List App. The App is meant to make the users daily planning and chores easier to manage. The App has a jQuery dependency .",
            "images": ["images/197x148.gif"],
            "url": "https://github.com/claustafari/Mini-Library-Greetr"
        },
        {
            "title": "Functional Page Map Application",
            "dates": "In progress",
