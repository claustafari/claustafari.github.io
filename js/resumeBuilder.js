...
var bio = {
    ...
    welcomeMessage: "Howdy! Welcome to my interactive resume application that I developed using jQuery. The resume reads all data from a JSON file and then dynamically modifies the DOM to display the information. Furthermore I customized the project by personalizing the design using CSS. It's an ongoing project, which explains why some parts are 'under construction'.",
